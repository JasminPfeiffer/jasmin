# Transkript – Demo 12 - When anyone can build, the person who decides WHAT to build becomes the bottleneck
...
- Capacity freed up
⇓
Product Manager is dead, it needs only product builder
⇓
Everyone to be a „builder“ !
It comes with a trade off & risks !

---
Specialized Agents working together
- making decisions, that should not be delegated

**Problems**
1. **Roles get blurred!** *(unterstrichen)*
   Data, designer, engineer and product mgmt people are lost where role starts & ends
2. **Doing vs. judging** *(unterstrichen)* of output & quality
   ⇓
...
1) context of changes to be ensured + quality cycles !
   ⇓
2) shared company brain / system (e.g. GitHub) + workspace map
   ⇓
